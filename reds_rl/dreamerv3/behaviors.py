...
class Greedy(nj.Module):
    ...
    def train(self, imagine, start, data, demo_feat=None, demo_action=None):
        return self.ac.train(imagine, start, data, demo_feat=demo_feat, demo_action=demo_action)
...
class Explore(nj.Module):
    ...
    def train(self, imagine, start, data, demo_feat=None, demo_action=None):
        ...
        traj, mets = self.ac.train(imagine, start, data, demo_feat=demo_feat, demo_action=demo_action)
        metrics.update(mets)
        return traj, metrics
