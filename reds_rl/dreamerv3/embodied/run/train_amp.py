...
def train_amp(
    agent, train_env, eval_env, train_env_fn, eval_env_fn, train_replay, reference_replay, eval_replay, logger, args
):
    ...
    def train_step(tran, worker):
        ...
        if should_log(step):
            ...
            logger.add(agent.report(eval_batch, reference_batch[0]), prefix="eval")
